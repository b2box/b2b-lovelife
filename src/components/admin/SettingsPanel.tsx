          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="p-3">
                  <h5 className="text-sm font-medium mb-2">China (CN)</h5>
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      <Label>Tier 1</Label>
                      <Input
                        type="number"
                        step="1"
                        value={settings.cn_tier1_pct}
                        onChange={(e) => setSettings({ ...settings, cn_tier1_pct: Number(e.target.value) })}
                      />
                    </div>
                    <div>
                      <Label>Tier 2</Label>
                      <Input
                        type="number"
                        step="1"
                        value={settings.cn_tier2_pct}
                        onChange={(e) => setSettings({ ...settings, cn_tier2_pct: Number(e.target.value) })}
                      />
                    </div>
                    <div>
                      <Label>Tier 3</Label>
                      <Input
                        type="number"
                        step="1"
                        value={settings.cn_tier3_pct}
                        onChange={(e) => setSettings({ ...settings, cn_tier3_pct: Number(e.target.value) })}
                      />
                    </div>
                  </div>
                </Card>
