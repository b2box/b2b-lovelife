    ...
    try {
      ...
      const { error: variantError } = await supabase
        ...
        .update({
          ...
          box_length_cm: form.box_length_cm,
          box_width_cm: form.box_width_cm,
          box_height_cm: form.box_height_cm,
          box_weight_kg: form.box_weight_kg,
          pcs_per_carton: form.pcs_per_carton,
          cbm_per_carton: form.cbm_per_carton,
